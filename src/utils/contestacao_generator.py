...
class ContestacaoGenerator:
    ...
    def generate_contestacao(self, dados_extraidos: dict, dados_reu: dict = None) -> str:
        ...
        prompt = f"""
Você é um advogado especialista em contestação judicial. Utilize o modelo padrão a seguir, preenchendo e adaptando os dados do caso com base nas informações extraídas da petição inicial.
...
Instruções:
- Substitua os campos do modelo conforme os dados extraídos.
- Mantenha a argumentação jurídica e a estrutura do modelo.
- Adapte os fatos e pedidos para refletir o caso concreto.
- Gere a peça completa e pronta para uso.
"""
